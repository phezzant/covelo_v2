...
export function TabBar() {
  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 bg-ink-light border-t border-parchment/10 sm:static sm:border-t-0 sm:border-b sm:bg-ink z-30">
        ...
        {TABS.map(({ href, label, icon: Icon }) => {
          ...
          return (
            <Link
              key={href}
              href={href}
              data-tour={href === "/app/research" ? "nav-research" : undefined}
